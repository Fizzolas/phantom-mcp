...
| PR  | Scope                                                                            | Status |
| --- | -------------------------------------------------------------------------------- | ------ |
| 1   | Contracts + registry + capability probe. Migrate 5 proof tools.                  | **this PR** |
| 2   | Fix MemoryManager API surface, delete chunker tool exposure, task state machine. | pending |
